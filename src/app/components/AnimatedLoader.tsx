...
const AnimatedLoader = () => {
  return (
    // This is the new full-screen, blurring wrapper
    <div className="fixed top-0 left-0 w-screen h-screen bg-black/30 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="main">
        <div className="up">
          <div className="loaders">
            ...
            <div className="loader"></div>
            <div className="loader"></div>
            <div className="loader"></div> {/* 10th loader */}
          </div>
      ...
      <style jsx global>{`
        /* I REMOVED the '.main' rule from here, 
          as the new wrapper handles centering.
        */
